            ...
            cloudinary.uploader.upload(file_path,  function(result) { 
                ...
                Publication.findOne({'user':req.user.sub, '_id': publicationId}).exec((err, publication) =>{
                    if(publication){
                        ...
                        Publication.findByIdAndUpdate(publicationId, {file:urlimage}, 
                            {new: true},
                ...
                }else{ return res.status(200).send({user:'error',status:0}); }
            });
            /****************************** */
      
        }else{  return removeFilesOfUploads(res, file_path, 'Extension no valida')}
